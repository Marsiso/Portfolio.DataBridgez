...
/// <summary>
///     <see cref="Argon2IdPasswordHasher"/> test library.
/// </summary>
public sealed class Argon2IdPasswordHasherTests
{
    ...
    public void HashPassword_NullReferencePassword_ThrowException()
    {
        ...
        IPasswordHasher<AppUser> passwordHasher = Activator.CreateInstance<Argon2IdPasswordHasher>();
    ...
    {
        // Arrange
        var passwordHasher = Activator.CreateInstance<Argon2IdPasswordHasher>();
    ...
    public void SplitPasswordHash_ReturnPasswordHashSaltAndKey()
    {
        ...
        // Act
        var result = Argon2IdPasswordHasher.TrySplitPasswordHash(samplePasswordHash,
